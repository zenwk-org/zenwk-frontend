...
import { useSidebarContext } from '@app/app/(dashboard)/user/utils/UseWidthSidebarContext';
...
import SidebarIcon from '@app/app/(dashboard)/user/components/icons/SidebarIcon';
import CloseSidebarIcon from '@app/app/(dashboard)/user/components/icons/CloseSidebarIcon';
import Tooltip from '@app/shared/ui/Tooltip';
import CalendarCheckIcon from '@app/app/(dashboard)/user/components/icons/CalendarCheckIcon';
import AlarmClockIcon from '@app/app/(dashboard)/user/components/icons/AlarmClockIcon';
import FolderRootIcon from '@app/app/(dashboard)/user/components/icons/FolderRoot';
import CurveIcon from '@app/app/(dashboard)/user/components/icons/CurveIcon';
import Link from 'next/link';
import ChevronRightIcon from '@app/app/(dashboard)/user/components/icons/ChevronRightIcon';
import BrainIcon from '@app/app/(dashboard)/user/components/icons/BrainIcon'; // nuevo icono IA (debes tenerlo o crearlo)
