...
import {
    ...
    getPathId,
} from '@app/app/(dashboard)/user/utils/personUtils';
...
import CompleteRegisterFormFields from '@app/app/(dashboard)/user/components/forms/CompleteRegisterFormFields';
