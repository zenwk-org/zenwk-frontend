...
import ProfileRingLoader from '@app/app/(dashboard)/user/components/profile/ProfileRingLoader';
...
const ProfileButtomForm = ({
    ...
    const getShapeClass = () => {
        if (shape === 'circle') return 'rounded-full hover:bg-indigo-200';
    ...
    /**
     * Función para determinar el contenido del botón
     * @returns
     */
    const renderButtonContent = (): ReactNode => {
        if (lineLoading && buttonLoading) {
            if (nameButtom) {
                return (
