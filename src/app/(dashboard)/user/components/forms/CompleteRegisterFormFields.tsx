...
import { formValidateUser } from '@app/app/(dashboard)/user/utils/formValidateUser';
import SelectGeneral, {
    Option,
} from '@app/app/(dashboard)/user/ui/inputs/SelectGeneral';
import InputText from '@app/app/(dashboard)/user/ui/inputs/InputText';
import FormErrorUser from '@app/app/(dashboard)/user/ui/forms/FormErrorUser';
import ProfileButtomForm from '@app/app/(dashboard)/user/components/profile/ProfileButtomForm';
import LoadButton from '@app/app/(auth)/components/LoadButton';
