...
import ProfileItemConfiguration from '@app/app/(dashboard)/user/components/profile/ProfileItemConfiguration';
import UpdateEmailSection from '@app/app/(dashboard)/user/ui/profile/UpdateEmailSection';
import UpdatePasswordSection from '@app/app/(dashboard)/user/ui/profile/UpdatePasswordSection';
import DeleteAccount from '@app/app/(dashboard)/user/ui/profile/DeleteAccount';
import AnimatedPage from '@app/app/(auth)/components/AnimatedPage';
import ProfileItemHeader from '@app/app/(dashboard)/user/components/profile/ProfileItemHeader';
